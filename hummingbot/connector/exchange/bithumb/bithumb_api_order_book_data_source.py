...
class BithumbAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def listen_for_order_book_snapshots(self, ev_loop: asyncio.AbstractEventLoop, output: asyncio.Queue):
        while True:
            try:
                ...
                self.logger().exception("Unexpected error fetching Bithumb order book snapshots")
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        raise NotImplementedError("Bithumb WebSocket order book stream is not implemented yet")
